    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: InkWell(
            ...
            child: const Icon(Icons.arrow_back_ios, color: AppColors.blackColor, size: 16)),
      ),
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    getTranslated(context, AppConstant.followingToSeeWhat).toString(),
                    style: const TextStyle(
                        fontSize: 22, color: AppColors.blackColor, fontFamily: AppFontFamily.poppinsMedium),
                  ),
                  Text(
                    getTranslated(context, AppConstant.goingOn).toString(),
                    style: const TextStyle(
                        fontSize: 22, color: AppColors.blackColor, fontFamily: AppFontFamily.poppinsMedium),
                  ),
                  Text(
                      getTranslated(context, AppConstant.hearAboutGreatEventsFirstFromOurBestLocalOrganizers)
                          .toString(),
                      style: const TextStyle(
                        ...
                        children: [
                          ...
                          Expanded(
                              child: settingProvider.organizationData[index].firstName != null
                                  ? Text(
                                      settingProvider.organizationData[index].firstName! +
                                          " " +
                                          settingProvider.organizationData[index].lastName!,
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                      color: settingProvider.organizationData[index].isFollow == true
